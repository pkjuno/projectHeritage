...
| ~~**6**~~ | ~~신고·차단·이미지 첨부~~ | ✅ 완료 — 백엔드 32개 + Flutter 19개 테스트 |
...
| 5 | 게시글에 이미지 첨부 | ✅ 완료. 저장소는 아직 로컬 디스크 — S3 이전은 `imageStorage.service.js` 한 파일만 고치면 되게 해뒀습니다 |
| 6 | 신고/차단 | ✅ 완료. 신고가 쌓여도 자동 숨김은 하지 않습니다 |
